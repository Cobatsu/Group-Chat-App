            ...
            data.getChatRoom.members.map((member, index) => {
              return (
                ...
                >
                  <i
                    className="fas fa-user"
                    style={{ color: memberColors[index], fontSize: 15 }}
                  />
                  ...
                  {data.getChatRoom.host._id == member._id && (
                    <i
                      ...
                      style={{ color: "#f0a500", fontSize: 11, marginLeft: 4 }}
                    />
                  )}
                </li>
              );
                  ...
                  >
                    ...
                    {msg.owner._id == currentUser._id ? (
                      <React.Fragment>
                        ...
                        <EditTextBubble
                          onClick={() => setIsBeingUpdatedID(msg._id)}
                        >
                          <i
                            style={{ color: "#ec4646" }}
